...
public class EditTextDel extends EditText implements View.OnFocusChangeListener {
	...
	private void init() {
		// 获取图片资源
		imgEnable = ContextCompat.getDrawable(context,R.drawable.edit_del_selector);
