...
/**
 * Created by fengchaojun on 2017/3/22.
 */
public class FullButton extends AppCompatButton {
    ...
    public FullButton(Context context) {
        this(context, null);
    }

    public FullButton(Context context, AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.buttonStyle);
    }

    public FullButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setup(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.FullButton);
        ...
        mNormalTextColor = a.getColor(R.styleable.FullButton_normalTextColor, mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.FullButton_pressedTextColor, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.FullButton_unableTextColor, mDefaultUnableTextColor);
        setTextColor();

        //set animation duration
        mDuration = a.getInteger(R.styleable.FullButton_animationDuration, mDuration);
        mStateBackground.setEnterFadeDuration(mDuration);
        mStateBackground.setExitFadeDuration(mDuration);

        //set background color
        mNormalBackgroundColor = a.getColor(R.styleable.FullButton_normalBackgroundColor, 0);
        mPressedBackgroundColor = a.getColor(R.styleable.FullButton_pressedBackgroundColor, 0);
        mUnableBackgroundColor = a.getColor(R.styleable.FullButton_unableBackgroundColor, 0);
        ...
        //set radius
        mRadius = a.getDimensionPixelSize(R.styleable.FullButton_radius, 0);
        mRound = a.getBoolean(R.styleable.FullButton_round, false);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(R.styleable.FullButton_strokeDashWidth, 0);
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.FullButton_strokeDashWidth, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(R.styleable.FullButton_normalStrokeWidth, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.FullButton_pressedStrokeWidth, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.FullButton_unableStrokeWidth, 0);
        mNormalStrokeColor = a.getColor(R.styleable.FullButton_normalStrokeColor, 0);
        mPressedStrokeColor = a.getColor(R.styleable.FullButton_pressedStrokeColor, 0);
        mUnableStrokeColor = a.getColor(R.styleable.FullButton_unableStrokeColor, 0);
        setStroke();
