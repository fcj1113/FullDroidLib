package cn.fulldroid.lib.pickphoto;
...
import cn.fulldroid.lib.pickphoto.adapter.PickGridAdapter;
import cn.fulldroid.lib.pickphoto.adapter.SpaceItemDecoration;
import cn.fulldroid.lib.pickphoto.model.GroupImage;
import cn.fulldroid.lib.pickphoto.model.PickData;
import cn.fulldroid.lib.pickphoto.util.PickConfig;
import cn.fulldroid.lib.pickphoto.util.PickPhotoHelper;
import cn.fulldroid.lib.pickphoto.util.PickPreferences;
import cn.fulldroid.lib.pickphoto.util.PickUtils;
import cn.fulldroid.lib.pickphoto.util.RxBus;
import cn.fulldroid.lib.pickphoto.util.event.ImageLoadOkEvent;
import cn.fulldroid.lib.pickphoto.widget.MyToolbar;
...
public class PickPhotoActivity extends AppCompatActivity {
    ...
    private void initToolbar() {
        ...
        myToolbar.setLeftIcon(R.drawable.pick_ic_open);
        myToolbar.setRightIcon(R.drawable.pick_ic_close);
