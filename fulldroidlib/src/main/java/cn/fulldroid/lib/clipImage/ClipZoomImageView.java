...

{
    ...
    private float scaleClip; //裁剪宽高比
    private boolean isCustom = false; //是否自定义裁剪宽高比
        ...
        mGestureDetector = new GestureDetector(context,
                new SimpleOnGestureListener() {
                    ...
                    public boolean onDoubleTap(MotionEvent e) {
                        Log.i("ClipZoomImageView", "-----------------11111111--------------------");
                        if (isAutoScale == true)
                            return true;
    ...
    public void setCustomScale(float scale) {
        this.scaleClip = scale;
        isCustom = true;
        Log.e("scale", "裁剪设置" + scale + "");
    }
    ...
    public boolean onScale(ScaleGestureDetector detector) {
        ...
        Log.i("ClipZoomImageView", "-----------------onScale--------------------");
    ...
    private RectF getMatrixRectF() {
        Log.i("ClipZoomImageView", "-----------------getMatrixRectF--------------------");
    ...
    public void onGlobalLayout() {
        if (once) {
            ...
            // 垂直方向的边距
            if (isCustom) {
                Log.e("scale", "设置" + scaleClip + "");
                mVerticalPadding = (int) (((float) getHeight() - ((float) getWidth() / scaleClip)) / 2);
            } else {
