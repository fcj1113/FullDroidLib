package cn.fulldroid.lib.dialog;
...
import cn.fulldroid.lib.dialog.widget.base.BaseDialog;
...
public class NormalListDialog extends BaseDialog<NormalListDialog> {
    ...
    private OnOperItemClickListener mOnOperItemClickListener;
    private LayoutAnimationController mLac;

    public void setOnOperItemClickListener(OnOperItemClickListener onOperItemClickListener) {
