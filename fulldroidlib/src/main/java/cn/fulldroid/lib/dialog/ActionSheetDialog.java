...
import cn.fulldroid.lib.dialog.widget.base.BottomBaseDialog;
...
public class ActionSheetDialog extends BottomBaseDialog<ActionSheetDialog> {
    ...
    private OnOperItemClickListener mOnOperItemClickL;
    private LayoutAnimationController mLac;

    public void setOnOperItemClickListener(OnOperItemClickListener onOperItemClickL) {
