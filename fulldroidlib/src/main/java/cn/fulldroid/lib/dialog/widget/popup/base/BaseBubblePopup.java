package cn.fulldroid.lib.dialog.widget.popup.base;
...
import cn.fulldroid.lib.animation.BounceEnter.BounceLeftEnter;
import cn.fulldroid.lib.animation.FadeExit.FadeExit;
import cn.fulldroid.lib.dialog.utils.CornerUtils;
import cn.fulldroid.lib.dialog.utils.StatusBarUtils;
import cn.fulldroid.lib.dialog.view.TriangleView;
import cn.fulldroid.lib.dialog.widget.internal.InternalBasePopup;
...
public abstract class BaseBubblePopup<T extends BaseBubblePopup<T>> extends InternalBasePopup<T> {
    ...
    public View onCreateView() {
        View inflate = View.inflate(mContext, R.layout.dialog_popup_bubble, null);
